    ...
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-block px-4 py-1.5 bg-green-50 text-[#03c75a] rounded-full text-sm font-bold mb-6 animate-bounce">
            AI 기반 스마트 블로깅 솔루션
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button 
              onClick={handleStart}
              className="w-full sm:w-auto px-10 py-5 bg-[#03c75a] text-white rounded-[2rem] font-black text-xl hover:scale-105 transition-all shadow-xl shadow-green-200"
            >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="relative bg-white p-8 rounded-[3rem] shadow-2xl border border-gray-100">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-xl font-black">실시간 레퍼런스 분석 중...</h3>
                </div>
            ...
            <div>
              ...
              <p className="text-lg text-gray-500 leading-[1.8] mb-8">
              ...
              <ul className="space-y-4 font-bold text-gray-700">
                <li className="flex items-center gap-3">
                  <div className="w-6 h-6 bg-blue-100 text-blue-500 rounded-full flex items-center justify-center text-[10px]"><i className="fas fa-check"></i></div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-black mb-4">왜 오토라이터인가요?</h2>
            <p className="text-gray-500">블로거들의 고충을 해결하기 위해 태어났습니다.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all">
              <div className="w-14 h-14 bg-orange-100 text-orange-500 rounded-2xl flex items-center justify-center text-2xl mb-8">
                <i className="fas fa-camera"></i>
              </div>
              <h3 className="text-xl font-bold mb-4">시각적 분석 기술</h3>
              <p className="text-gray-500 leading-relaxed">업로드한 사진의 색감, 사물, 분위기를 AI가 시각적으로 분석하여 글에 생생함을 더합니다.</p>
            </div>
            <div className="p-10 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all">
              <div className="w-14 h-14 bg-[#03c75a]/10 text-[#03c75a] rounded-2xl flex items-center justify-center text-2xl mb-8">
                <i className="fas fa-clock"></i>
              </div>
              <h3 className="text-xl font-bold mb-4">단 30초면 완성</h3>
              <p className="text-gray-500 leading-relaxed">1시간 넘게 걸리던 포스팅 작성이 단 30초 만에 끝납니다. 당신의 소중한 시간을 아끼세요.</p>
            </div>
            <div className="p-10 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all">
              <div className="w-14 h-14 bg-purple-100 text-purple-500 rounded-2xl flex items-center justify-center text-2xl mb-8">
                <i className="fas fa-tags"></i>
              </div>
              <h3 className="text-xl font-bold mb-4">SEO 최적화 태그</h3>
              <p className="text-gray-500 leading-relaxed">검색 결과 상단 노출을 돕기 위해 최신 인기 키워드를 포함한 해시태그를 자동으로 생성합니다.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto bg-[#03c75a] rounded-[3rem] p-12 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <button 
              onClick={handleStart}
              className="px-12 py-6 bg-white text-[#03c75a] rounded-[2rem] font-black text-2xl hover:bg-gray-50 transition-all shadow-xl active:scale-95"
            >
